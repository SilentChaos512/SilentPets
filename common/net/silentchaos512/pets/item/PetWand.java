...
public class PetWand extends ItemSG {
  ...
  public void addRecipes() {
    ...
    GameRegistry.addShapedRecipe(new ItemStack(this), "lpl", " g ", " g ", 'l', new ItemStack(
        Items.dye, 1, 4), 'p', MultiItem.getStack(Names.PET_ESSENCE_RAW), 'g', Items.gold_ingot);
  }
  ...
  public void registerIcons(IIconRegister reg) {
    ...
    for (int i = 0; i < icons.length; ++i) {
      icons[i] = reg.registerIcon(Strings.RESOURCE_PREFIX + itemName + "_"
          + State.values()[i].name());
    }
  }
