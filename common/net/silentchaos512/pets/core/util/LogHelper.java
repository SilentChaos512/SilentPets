...
public class LogHelper {
  ...
  private static Logger logger = Logger.getLogger(SilentPets.MOD_ID);
  ...
  public static void log(String logLevel, Object object) {
    ...
    System.out.println((new Date()).toString() + " [" + SilentPets.MOD_ID + "] " + logLevel + " "
        + object.toString());
  }
  ...
  public static void derpRand() {
    ...
    String s = "";
    for (int i = 0; i < SilentPets.instance.random.nextInt(6); ++i) {
      s += " ";
    }
    log(DEBUG, s + "Derp!");
  }
