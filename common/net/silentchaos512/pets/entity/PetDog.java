...
public class PetDog extends EntityPet {
  ...
  public void onLivingUpdate() {
    ...
    if (!this.worldObj.isRemote && this.isShaking && !this.field_70928_h && !this.hasPath()
        && this.onGround) {
  ...
  public float getShakeAngle(float p_70923_1_, float p_70923_2_) {
    ...
    float f2 = (this.prevTimeWolfIsShaking + (this.timeWolfIsShaking - this.prevTimeWolfIsShaking)
  ...
  public float getInterestedAngle(float p_70917_1_) {
    ...
    return (this.field_70924_f + (this.field_70926_e - this.field_70924_f) * p_70917_1_) * 0.15F
        * (float) Math.PI;
  }
  ...
  public float getTailRotation() {
    ...
    return this.isAngry() ? 1.5393804F : (this.isTamed() ? (0.55F - (20.0F - this.dataWatcher
